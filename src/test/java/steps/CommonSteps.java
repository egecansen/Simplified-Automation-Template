...
public class CommonSteps extends PageObjectStepUtilities<ObjectRepository> {
    ...
    @Given("Acquire component by {} named {} from {} component list on the {} and save the {} attribute of {} element")
    public void saveSelectComponentElementAttribute(
            String elementFieldName,
            String elementText,
            String componentListName,
            String pageName,
        ...
        webInteractions.saveAttributeValue(element, attributeName, targetElementFieldName, pageName);
    }
